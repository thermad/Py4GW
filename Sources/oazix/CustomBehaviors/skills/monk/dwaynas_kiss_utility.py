...
class DwaynasKissUtility(CustomSkillUtilityBase):
    """
    Utility for Dwayna's Kiss - a simple healing spell.
    ...
    def __init__(self,
        ...
        super().__init__(
            event_bus=event_bus,
            skill=CustomSkill("Dwaynas_Kiss"),
    ...
    def _get_targets(self) -> list[custom_behavior_helpers.SortableAgentData]:
        ...
        targets: list[custom_behavior_helpers.SortableAgentData] = custom_behavior_helpers.Targets.get_all_possible_allies_ordered_by_priority_raw(
            ...
            condition=lambda agent_id: Agent.GetHealth(agent_id) < 0.80,
