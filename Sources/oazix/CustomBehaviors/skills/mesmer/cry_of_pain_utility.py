...
class CryOfPainUtility(CustomSkillUtilityBase):
    ...
    def detect_casting_enemies(self) -> list[SortableAgentData]:
        ...
        targets = custom_behavior_helpers.Targets.get_all_possible_enemies_ordered_by_priority_raw(
            ...
            condition=lambda agent_id: condition(agent_id) and Agent.IsCasting(agent_id) and GLOBAL_CACHE.Skill.Data.GetActivation(Agent.GetCastingSkillID(agent_id)) >= 0.450,
